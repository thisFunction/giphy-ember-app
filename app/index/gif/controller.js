...
export default Controller.extend({
  ...
  giphyIsFavorite: computed("model.favorites.@each.userRating", "currentGiphyId", function() {
    const giphyId = get(this, "currentGiphyId");
    const favorites = this.store.peekRecord("favorite", giphyId);
    return favorites
  }),
  userRating: computed("model.favorites.@each.userRating", "currentGiphyId", function() {
    const giphyId = get(this, "currentGiphyId");
    const favorites = this.store.peekRecord("favorite", giphyId);
  ...
  actions: {
    clickStar(rating) {
      ...
      if (favorites) {
        this.store.findRecord("favorite", giphyId)
